<template>
    <div>
       ...
       <div class="content">
         <div class="container-fluid">
           <div class="row" v-if="is('SUPERADMIN')">
                               ...
                               <table  class=" table table-bordered table-condensed table-hover table-sm">
                                   <thead class="bg-info  disabled color-palette pd-0">
                                       <tr  class="info">
                                           ...
                                           <th v-if="is('SUPERADMIN')"><small><strong>ACCIONES</strong></small></th>
                                   ...
                                   <tbody >
                                       <tr v-for="depe in dependencias" :key="depe.iddependencia">
                                           ...
                                           <td>{{ depe.iddependencia }}</td>
                                           <td>{{ depe.depe_nombre }}</td>
                                           <td>{{ depe.depe_ciudad }}</td>
                                           <td>{{ depe.depe_direccion}}</td>
                                           <td>{{ depe.depe_abreviado }}</td>  
                                           
                                           <td class="text-center" v-if="is('SUPERADMIN')">
    ...
    export default {
      ...
      methods: {
          listauser(page){
              ...
              axios.get('/listardepeexterno?page='+page)
                   .then(response=>
                   {
