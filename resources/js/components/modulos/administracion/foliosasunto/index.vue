...
<div>
    ...
    <div class="content">
        <div class="container" v-if="is('SUPERADMIN | ADMINISTRADOR')">
            <div class="row">
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header pt-1 pb-1">
                            <p>Actualizar folios y asunto</p>
                        </div>
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <!-- <button class="btn btn-sm btn-primary" @click="buscardoc"><i class="fa fa-search"></i> Buscar</button> -->

                                <router-link :to="'/Tramites/'+busdoc.iddocumento+'/Editar'" class="btn btn-sm btn-primary">
                                    Buscar
                                </router-link>
