                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td v-if=" (getBuscarDocumento.docu_emailorigen || getBuscarDocumento.docu_telef)"><strong>Correo/Celular: </strong></td>
                            <td v-if="(getBuscarDocumento.docu_emailorigen || getBuscarDocumento.docu_telef)" style="font-size: 11px">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="list-group float-end">
                                            <a v-for="(operacion, index) in getBuscarOperaciones" :key="index" :class="{
                                                    'list-group-item text-decoration-none': true,
                                                    'list-group-item-success text-decoration-none':
                                                    parseInt(operacion.oper_idtope) === 3 || parseInt(operacion.oper_idtope === 4),
                                                    'list-group-item-danger active text-decoration-none':
...
export default {
    ...
    methods: {
        ...
        regresar() {
            var url='/buscar/buscarExpedienteModal/%s'
            window.location.assign(url.replace(/%s/g, this.getBuscarDocumento.expediente))
        }
    },
};
</script>
