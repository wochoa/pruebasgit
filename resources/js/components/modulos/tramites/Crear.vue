    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row mt-2">
                ...
                <div class="col-12">
                    <div class="card card-danger card-outline card-revenue-budget">
                                ...
                                <div class="col-md-6 p-0">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-2">
                                                <input type="number" class="form-control form-control-sm" placeholder="Cod." v-model="formdocumentos.cod_unidad" @keyup="capturaiddepe()">
                                            </div>
                                            <div class="col-sm-7">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="text-center">
                            ...
                            <h4>
                                ...
                                REGISTRO DOCUMENTO: {{ ('00000000' + resultado.documento).slice(-8) }} <br>

                                REGISTRO EXPEDIENTE: {{ ('00000000' + resultado.expediente).slice(-8) }}
                    ...
                    <div class="modal-footer float-right p-1">
                        <button type="button" class="btn btn-danger" @click="iraprocesotram"><i class="fa-solid fa-right-from-bracket"></i> Ir a proceso</button>
                        <button type="button" class="btn btn-primary" @click="generarnuevotramite"><i class="fa-solid fa-file-circle-plus"></i> Nuevo trámite</button>
                    </div>
                </div>
                <!-- /.modal-content -->
            </div>
        ...
        <docu-invoker ref="foo" :iframe="iframe" :route-invoker-get="routeInvokerGet" :route-invoker-post="routeInvokerPost" :ruta="ruta" @firmado="firmado" :usuario="usuario"  />
...
export default {
    ...
    data() {
        return {
            formdocumentos: {
                ...
                correlativodoc: '',
                newcorrelativodoc: '', //cuando se coloca manualmente
                siglasdoucmento: '',
                ciudad: '',
                direccion: '',
                clavedoc: '',
    ...
    methods: {
        ...
        setExpedienteResponse() {
            ...
            this.formdocumentos.camporeferencia = this.$route.params.iddocumento
            this.agregarreferenias()
        ...
        tipostramite() {
            ...
            axios.get(url)
                .then(response => {
                    ...
                    this.formdocumentos.newcorrelativodoc = this.datosuser.tipodoc.correlativo;
        ...
        capturaiddepe() {
            ...
            axios.get(url)
                .then(response => {
                    ...
                    this.formdocumentos.textdepe = this.representantedestino[0].depe_nombre;
        ...
        */
        ...
        generar_tramite() {
            ...
            */
            ...
            formData.append("fcorrelativodocnew", this.formdocumentos.newcorrelativodoc); // correlativo del numero de documento manualamente
