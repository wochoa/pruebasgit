...
<div>
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <button class="btn btn-sm btn-dark float-right" @click="ejecutaayudafirma">Habilitar firmador</button>
                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="group">
                                                ...
                                                <input type="number" class="form-control form-control-sm" v-model="formData.iddocumento" @keyup.enter="buscarDocumentos()">
                                            </div>
                                        </div>
                                        <div class="col-md-5">
                                            <div class="group">
                                        ...
                                        <div class="col-md-2">
                                            <div class="group">
                                                <label class="text-sm">Tipo trámite</label>
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-sm-4">
                                            <div class="group">
                                                ...
                                                <select v-model="formData.tipdoc" class="form-control form-control-sm" @change="buscarDocumentos()">
                                                    <option :value="null">Todos</option>
                                                    <option v-for="tdoc in tipoDocumentos" :value="tdoc.idtdoc">{{ tdoc.tdoc_descripcion }}</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="group">
                                                <label class="text-sm">Numero documento</label>
                                                <input type="number" class="form-control form-control-sm" v-model="formData.numdoc" placeholder="Ejemplo: 7" @keyup.enter="buscarDocumentos()">
                                            </div>
                                        </div>
                                        <div class="col-md-5">
                                            <div class="group">
                                                <label class="text-sm">Asunto documento</label>
                                                <input type="text" class="form-control form-control-sm" v-model="formData.asuntodoc" placeholder="Ejemplo asunto: Solicitud de asignacion presupuestal..">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr v-for="(documento, index) in documentos.data" :key="index" :set="(dias = moment().diff(moment(documento.created_at), 'days'))" :class="operSelected.indexOf(documento.idoperacion) >= 0 ? 'danger': documento.depe_destino != null? 'success': 'blanco' " @click="selectArchivar(documento)">
                                            ...
                                            <td width="20%">
                                                ...
                                                <div v-if="documento.oper_detalledestino" style="clear: both;"><small><strong>Detalle: </strong>{{ documento.oper_detalledestino }}</small> </div>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
    ...
    <!-- ...................... -->
    <docu-invoker ref="foo" :iframe="iframe" :route-invoker-get="routeInvokerGet" :usuario="usuario" :route-invoker-post="routeInvokerPost" :ruta="ruta" @firmado="firmado" />
</div>
</template>
...
import DocuInvoker from './FirmaPeru'
...
export default {
    ...
    mounted() {
        ...
        // para hacer funcionar la firma
        // this.ejecutaayudafirma()
    ...
    methods: {
        buscarTipoDocumento() {
            ...
            axios.get(url).then(response => {
                this.tipoDocumentos = response.data.listadoc                
            })
        },
        ...
        ejecutaayudafirma() {
            var url = this.ruta + '/testfirma/'
            let params = `scrollbars=no,resizable=no,status=no,location=no,toolbar=no,menubar=no,width=50,height=20`;
            window.open(url, 'FIRMA PERÚ', params);
            setTimeout(function () {
            ...
            if (this.verificarDerivado()) {
                ...
                if (this.docIndexes.length > 0) {
                    this.$router.push({
                        ...
                        params: {
                            idrecepcion: this.documentos.data[this.docIndexes[0]].docu_idexma,
