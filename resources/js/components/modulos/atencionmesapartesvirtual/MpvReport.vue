            ...
            <div class="row">
                <div class="col-sm-6">
                    <ul class="nav nav-tabs" id="custom-content-above-tab" role="tablist">
                        ...
                        <li class="nav-item">
                            <router-link :to="'/Tramites/virtual-reporte'" class="nav-link active" id="derivados" data-toggle="pill" aria-controls="custom-content-above-home" aria-selected="true">
                                Reportes MPV
                            </router-link>
                        </li>
            ...
            <div class="row justify-content-center mt-2">
                <div class="col-sm-12">
                    <div class="card card-primary">
                        <div class="card-header">REPORTE MESA DE PARTES VIRTUAL</div>
                        <div class="card-body">
                            <div class="row" style="width: 100%;margin-left: -0px;">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        <p>
                                            <button type="submit" class="btn btn-danger" :disabled="getting" @click="exportarPdf(1)">Exportar recibidos PDF</button>
...
export default {
    ...
    methods: {
        nombredependencia() {
            ...
            var url='/nombredepexuser'
            axios.get(url)
            .then(res=>{
              this.dependencia=res.data
            })
        },
        putHasta() {
                    ...
                    .then(response => {
                        if (response.data.length > 0) {
                            ...
                            configTable.columns = [{
                                ...
                                {
                                    header: 'Documento',
                                    dataKey: 'docu_numero_doc'
                                },
                                {
                                    header: 'Firmante',
                                    dataKey: 'datos_remitente'
                                },
                                {
                                    header: 'Asunto',
                                    dataKey: 'docu_asunto'
                                ...
                                {
                                    header: 'Situación',
                                    dataKey: 'docu_situacion'
                                },
                            ]

                            header = [{
                                    text: 'REGISTROS' + (tipo === 1 ? ' RECIBIDOS ' : ' ATENDIDOS ') + 'POR MPV DE LA DEPENDENCIA: ' + this.dependencia,
                                    x: 60,
                                    y: 15
                                },
                                {
