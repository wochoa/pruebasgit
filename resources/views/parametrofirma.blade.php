...
header("Access-Control-Allow-Methods: PUT, POST, GET, OPTIONS, DELETE, *");
    ...
    $param ='{
                ...
                "documentToSign":"http://stdv.test/demo?id=42282733&secret=abcd",
                "certificateFilter": ".*",
                "webTsa": "",
                "userTsa": "",
                "passwordTsa": "",
                ...
                "oneByOne": true,
                "signatureStyle": 1,
                "imageToStamp":"http://stdv.test/img/stamp3_1.png",
                "stampTextSize": 14,
                "stampWordWrap": 37,
                ...
                "positionx": 20,
                "positiony": 20,
                "uploadDocumentSigned":"http://stdv.test/Uploadx.php?id=42282733&secret=xyz",
                "certificationSignature": false,
                "token":"'.$response.'"
        }';
        //echo $param;
        echo base64_encode($param);
        // echo $_SESSION["rutapdf"];
    //    echo Session('rutapdf');
?>